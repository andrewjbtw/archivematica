...
def atom_dips(request):
    ...
    if form.is_valid():
        ...
        opts = []
        char_fields = ['dip_upload_atom_url', 'dip_upload_atom_email', 'dip_upload_atom_password',
                       'dip_upload_atom_rsync_target', 'dip_upload_atom_rsync_command', 'dip_upload_atom_version']
