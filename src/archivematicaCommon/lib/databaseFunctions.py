...
def insertIntoEvents(fileUUID="", eventIdentifierUUID="", eventType="", eventDateTime=getUTCDate(), eventDetail="", eventOutcome="", eventOutcomeDetailNote=""):
    ...
    event = Event(event_id=eventIdentifierUUID, file_uuid_id=fileUUID,
...
def insertIntoDerivations(sourceFileUUID="", derivedFileUUID="", relatedEventUUID=""):
    ...
    derivation = Derivation(source_file_id=sourceFileUUID,
...
def insertIntoFPCommandOutput(fileUUID="", fitsXMLString="", ruleUUID=""):
    ...
    """
    output = FPCommandOutput(file_id=fileUUID, content=fitsXMLString
                             , rule_id=ruleUUID)
    output.save()
