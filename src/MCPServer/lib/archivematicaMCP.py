...
def watchDirectories():
    ...
    for dir in watched_directories:
        directory = dir.watched_directory_path.replace("%watchDirectoryPath%", watched_dir_path, 1)

        # Tuple of variables that may be used by a callback
        row = (dir.watched_directory_path, dir.chain_id, dir.only_act_on_directories, dir.expected_type.description)
        ...
        actOnFiles=True
        if dir.only_act_on_directories:
            actOnFiles=False
